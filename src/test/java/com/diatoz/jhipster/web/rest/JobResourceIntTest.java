...
public class JobResourceIntTest {
     ...
     *
     * @see com.diatoz.jhipster.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final JobResource jobResource = new JobResource(jobRepository, jobMapper, mockJobSearchRepository);
