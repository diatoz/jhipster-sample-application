...
import com.diatoz.jhipster.repository.JobRepository;
import com.diatoz.jhipster.repository.search.JobSearchRepository;
import com.diatoz.jhipster.web.rest.errors.BadRequestAlertException;
import com.diatoz.jhipster.web.rest.util.HeaderUtil;
import com.diatoz.jhipster.web.rest.util.PaginationUtil;
import com.diatoz.jhipster.service.dto.JobDTO;
import com.diatoz.jhipster.service.mapper.JobMapper;
...
public class JobResource {
    ...
    public ResponseEntity<List<JobDTO>> getAllJobs(Pageable pageable) {
        ...
        Page<JobDTO> page = jobRepository.findAll(pageable).map(jobMapper::toDto);
    ...
    public ResponseEntity<JobDTO> getJob(@PathVariable String id) {
        ...
        Optional<JobDTO> jobDTO = jobRepository.findById(id)
            .map(jobMapper::toDto);
